## notes
## download from github in zip file
...
###### Method 3 w/dupes ###### 
mmALL_073120_csv <- read_csv("/Users/aishatsadiq/Library/Mobile Documents/iCloud~md~obsidian/Documents/PhD/CCSS Data Fellow/mmALL_073120_csv.csv")
View(mmALL_073120_csv)
...
PreprocData2 <- PreprocData %>% select(-year)

###### Rename the columns w/ dplyr and base R ###### 
PreprocData %>%
...
###### Find missing cells
PreprocData3 <- is.na(PreprocData2)
...
######  confirm no missing numeric observations in new df
...
PreprocData_imp <- mice(PreprocData2, m = 5, seed = 31415, method = "cart")
...
global_population <- read_csv("/Users/aishatsadiq/Library/Mobile Documents/iCloud~md~obsidian/Documents/PhD/CCSS Data Fellow/Data_Preprocessing_R-master/Data/population.csv") %>% 
...
Preproc_join <- Preproc_dates %>% 
  dplyr::inner_join(Preproc_dates, global_population, by = c("country", "startyear"))
View(Preproc_join)
